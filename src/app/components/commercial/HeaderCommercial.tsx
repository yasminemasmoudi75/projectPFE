    ...
    <header className="sticky top-0 z-40 h-16 bg-white border-b border-slate-200 flex-shrink-0">
      <div className="flex items-center justify-between px-6 h-full gap-4">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Rechercher devis, projet, client…"
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="text-left hidden sm:block">
                <p className="text-[13px] font-semibold text-slate-900 leading-tight">Mohamed Commercial</p>
                <p className="text-[11px] text-slate-500">Commercial</p>
              </div>
