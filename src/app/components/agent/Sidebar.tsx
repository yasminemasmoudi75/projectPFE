...
import {
  LayoutDashboard, Users, AlertCircle, History,
  Calendar, FileText, Contact2, LogOut, ChevronDown,
} from 'lucide-react';
...
const groups = [
  ...
  },
  {
    name: 'CRM',
    items: [
      { id: 'contacts',     label: 'Contacts',          icon: Contact2,    color: 'violet'  },
      { id: 'societes',     label: 'Sociétés',          icon: Users,       color: 'indigo'  },
      { id: 'activities',   label: 'Activités Clients', icon: Calendar,    color: 'emerald' },
      { id: 'reclamations', label: 'Réclamations',      icon: AlertCircle, color: 'rose'    },
    ],
  },
  {
    name: 'Suivi',
    items: [
      ...
      { id: 'rapports',   label: 'Rapports',   icon: FileText, color: 'cyan' },
    ],
  },
];
        ...
        <div className="px-4 py-4 border-b border-slate-200">
          <div className="w-full flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-100 hover:border-blue-300 transition-all cursor-pointer group">
            ...
            <div className="flex-1 min-w-0 text-left">
              <p className="text-sm font-semibold text-slate-900 truncate">Secrétaire Agent</p>
