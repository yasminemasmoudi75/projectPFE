...
const FavForm = () => {
    ...
    const { currentFav, loading: loadingSlice } = useSelector((state) => state.fav);
    ...
    // Cin is stored separately - it's a Tiers field, not part of FavMaster
    ...
    const handleClientSelect = (clientCode) => {
        ...
        if (selectedClient) {
            setFormData(prev => ({
                ...
                LibTiers: selectedClient.Raisoc || '',   // Tiers uses Raisoc, FavMaster stores it as LibTiers
                Adresse: selectedClient.Adresse || '',
                Ville: selectedClient.Ville || '',
            }));
            // Cin belongs to Tiers model, not FavMaster - keep separate
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEdit) {
                ...
                toast.success('Fav mis à jour');
            } else {
                await dispatch(createFav(payload)).unwrap();
                toast.success('Fav créé avec succès');
            }
            navigate('/fav');
        } catch (err) {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        {isEdit ? 'Mettre à jour' : 'Finaliser la Facture'}
                    </button>
                </div>
            </div>

            <form id="Fav-form" onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8 font-sans">
                <div className="space-y-8">
                    ...
                    <div className="card-luxury p-0 overflow-hidden border-none shadow-soft-xl bg-white/60">
                        ...
                        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="group">
                                <label className="label-modern italic tracking-[0.2em] mb-2 px-1">Code Fave</label>
                                <input
                                    type="text"
                                    name="CodDev"
                            ...
                            <div className="group">
                                <label className="label-modern italic tracking-[0.2em] mb-2 px-1">Type de Fav</label>
                                <input
                                    type="text"
                                    name="type"
                                    value={formData.type || ''}
                            ...
                            <div className="md:col-span-2 group">
                                ...
                                <textarea
                                    ...
                                    placeholder="Notes internes sur ce Fav..."
                                    maxLength="255"
                                />
                            </div>
