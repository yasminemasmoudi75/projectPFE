                            ...
                            {filteredClients.length === 0 ? (
                                ...
                                paginatedClients.map((client) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="space-y-1">
                                                ...
                                                <div className="flex items-center gap-2 text-sm text-slate-600">
                                                    ...
                                                    {client.Tel ? (
                                                        <a 
                                                            href={getWhatsAppLink(client.Tel)} 
                                                            target="_blank" 
                                                            rel="noopener noreferrer"
                                                            onClick={(e) => e.stopPropagation()}
                                                            className="hover:text-emerald-600 hover:underline flex items-center gap-1 transition-colors"
                                        ...
                                        <td className="px-6 py-5">
                                            {client.classeAuto ? (
                                                <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider border shadow-sm ${
